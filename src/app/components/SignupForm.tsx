    ...
    <FinalForm
      ...
      render={({ handleSubmit, submitting, submitError }) => (
        <form
          ...
          className="grid grid-cols-1 my-10 py-10 sm:grid-cols-2 md:grid-cols-2 gap-6 bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6 sm:p-8 max-w-5xl w-full mx-auto"
          {...props}
        >
          {children}
